...
#<
#
# Function: str old = p6_aws_env_default_sso_start_url_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_default_sso_start_url_source() {
    local val="${1:-}"

    local old="${AWS_DEFAULT_SSO_START_URL_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_DEFAULT_SSO_START_URL_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_default_sso_region_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_default_sso_region_source() {
    local val="${1:-}"

    local old="${AWS_DEFAULT_SSO_REGION_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_DEFAULT_SSO_REGION_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_sso_start_url_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_sso_start_url_source() {
    local val="${1:-}"

    local old="${AWS_SSO_START_URL_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_SSO_START_URL_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_sso_region_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_sso_region_source() {
    local val="${1:-}"

    local old="${AWS_SSO_REGION_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_SSO_REGION_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_sso_account_name_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_sso_account_name_source() {
    local val="${1:-}"

    local old="${AWS_SSO_ACCOUNT_NAME_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_SSO_ACCOUNT_NAME_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_sso_account_id_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_sso_account_id_source() {
    local val="${1:-}"

    local old="${AWS_SSO_ACCOUNT_ID_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_SSO_ACCOUNT_ID_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_sso_role_name_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_sso_role_name_source() {
    local val="${1:-}"

    local old="${AWS_SSO_ROLE_NAME_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_SSO_ROLE_NAME_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_login_default_sso_region_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_login_default_sso_region_source() {
    local val="${1:-}"

    local old="${AWS_LOGIN_DEFAULT_SSO_REGION_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_LOGIN_DEFAULT_SSO_REGION_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_eks_cluster_name_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_eks_cluster_name_source() {
    local val="${1:-}"

    local old="${AWS_EKS_CLUSTER_NAME_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_EKS_CLUSTER_NAME_source" "$val"
    fi
...
#<
#
# Function: str old = p6_aws_env_codebuild_project_name_source([val=])
#
#  Args:
#	OPTIONAL val - []
#
...
#>
######################################################################
p6_aws_env_codebuild_project_name_source() {
    local val="${1:-}"

    local old="${AWS_CODEBUILD_PROJECT_NAME_source}"

    if ! p6_string_blank "$val"; then
        p6_env_export "AWS_CODEBUILD_PROJECT_NAME_source" "$val"
    fi
