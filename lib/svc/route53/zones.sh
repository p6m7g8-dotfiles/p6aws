...
p6_aws_svc_route53_zones_hosted_id_from_zone() {
    ...
    p6_aws_cli_cmd route53 list-hosted-zones --query "'HostedZones[].[Name, Id]'" --output text | p6_filter_row_select "$zone" | p6_filter_column_pluck 3 | p6_filter_column_pluck 3 "/"
}
